...
export const managerPermissionConfig: Record<string, ModuleFeatureMap> = {
  ...
  reportManagement: {
    ...
    ibCommissionReport: ["Commission Report", "IB Commission Report"],
    ibCommissionWithdrawReport: ["IB Commission Withdraw Report"],
    ibUsersReport: ["IB Users Report"],
  ...
  settingsManagement: {
    ...
    enabledDisabledManager2fa: ["Enabled/Disabled Subadmin 2FA", "Enabled/Disabled Manager 2FA"],
    enabledDisabledSubadmin2fa: ["Enabled/Disabled Subadmin 2FA"],
    enabledDisabledUser2fa: ["Enabled/Disabled User 2FA"],
    manager2faList: ["Subadmin 2FA List", "Manager 2FA List"],
    subadmin2faList: ["Subadmin 2FA List"],
  ...
  cryptoWalletManagement: {
    cryptoWalletList: ["Broker Crypto Wallet List", "Crypto Wallet List"],
    addCryptoWallet: ["Create Broker Crypto Wallet", "Add Crypto Wallet"],
    editCryptoWallet: ["Edit Broker Crypto Wallet", "Edit Crypto Wallet"],
    deleteCryptoWallet: ["Delete Broker Crypto Wallet", "Delete Crypto Wallet"],
  },
};
