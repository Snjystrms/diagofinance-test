  ...
  return (
    <IbPageShell>
      <IbPageHeader
        ...
        description="Browse Reffered Users, Sub Partners, and rebate records from the same reporting surface."
        actions={
            ...
            {clientsLoading && clients.length === 0 ? <TableSkeleton /> :
             clients.length > 0 ? (
              ...
              <EmptyState
                ...
                description={clientsSearch.query ? "No Reffered Users match your search." : "Direct user registrations will appear here when activity starts."}
                icon={<Users className="h-5 w-5" />}
              />
            ) : null}
          </TabsContent>
