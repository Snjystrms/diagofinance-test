        ...
        >
          {loading ? (
            ...
            >
              ...
              >
                <defs>
                  <linearGradient id="rebateBarGradientDialog" x1="0" y1="0" x2="0" y2="1">
                ...
                <Bar
                  dataKey="rebates"
                  fill="url(#rebateBarGradientDialog)"
                  radius={[6, 6, 0, 0]}
                  maxBarSize={40}
                >
    ...
    <>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <IbMetricCard
          ...
          description="Volume from your own Reffered Users"
          icon={<DollarSign className="h-5 w-5" />}
          accent="emerald"
        />
        <IbMetricCard
