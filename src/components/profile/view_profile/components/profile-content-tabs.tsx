              ...
              {totalPages > 1 ? (
                <div className="mt-5 flex items-center justify-between">
                  <div className="text-sm text-muted-foreground">
                    ...
                    {Math.min(currentPage * itemsPerPage, loginHistory.length)}{" "}
                    of {loginHistory.length} entries
                  </div>
                  <div className="flex items-center gap-2">
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        onSetCurrentPage((prev) => Math.max(1, prev - 1))
                      }
...
type BankTabProps = {
  ...
  onUpdateBankDetails: (
    field: keyof BankDetailsFormState,
    value: string,
  ) => void;
    ...
    <TabsContent value="bank" className="space-y-6">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">
            Save one or more bank accounts. Each account must be verified before
            it can be used for withdrawals.
          </p>
        </div>
        {!isBankEditing ? (
          <Button
      ...
      {bankDetailsList.length > 0 ? (
        <div className="mx-auto grid w-full max-w-5xl gap-3 md:grid-cols-2">
          {bankDetailsList.map((entry) => {
            const isActiveEdit =
              isBankEditing && entry.id === bankDetailsRecordId;
                    ...
                    <div className="min-w-0 flex-1 space-y-2">
                      ...
                      <div className="flex flex-wrap items-center gap-2 pt-1">
                        <Button
                          ...
                          disabled={
                            bankDetailsSaving || bankDetailsDeletingId !== null
                          }
                          className="gap-1"
                        >
          ...
          <CardContent className="flex flex-col items-center justify-center gap-3 p-10 text-center">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                Click &quot;Add Bank Details&quot; above to save your first
                account.
              </p>
            </div>
          </CardContent>
              ...
              <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      onUpdateBankDetails(
                        "accountName",
                        sanitizePersonText(e.target.value).slice(0, 80),
                      )
                    }
                    className={
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      onUpdateBankDetails(
                        "accountNumber",
                        sanitizeIdentifierInput(e.target.value, 34),
                      )
                    }
                    className={
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      onUpdateBankDetails(
                        "ifscSwiftCode",
                        sanitizeIdentifierInput(e.target.value, 20),
                      )
                    }
                    className={
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={
                      bankValidationErrors.bankName ? "border-destructive" : ""
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      onUpdateBankDetails("bankAddress", e.target.value)
                    }
                    className={
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value={LOCATION_OTHER_VALUE}>
                        Other
                      </SelectItem>
                    </SelectContent>
                  </Select>
                  {bankCountryMode === "other" ? (
                    <Input
                      ...
                      className={
                        bankValidationErrors.country ? "border-destructive" : ""
                      }
      ...
      <Dialog
        ...
        onOpenChange={(open) => {
          if (!open && bankDetailsDeletingId === null)
            onCancelDeleteBankDetails();
        }}
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              This action cannot be undone. The selected bank account will be
              permanently removed.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
