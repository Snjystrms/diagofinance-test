...
export function Header() {
  ...
  const managerQuickLinks = useMemo(
    () =>
      isManagerUser ? getManagerHeaderQuickLinks(user?.managerPermissions) : [],
  ...
  const { data: is2FAEnabled = false, isFetching: isLoading2FAStatus } =
    useQuery({
      ...
      queryFn: async () => {
        ...
        try {
          ...
          return response.success && response.data
            ? Boolean(response.data.google_2FA_status)
            : false;
        } catch {
          return false;
        }
        ...
        <div className="flex items-center gap-2 sm:gap-2.5 flex-shrink-0">
          ...
          >
            {isLoading2FAStatus ? (
              ...
              <div
                className={`h-2 w-2 rounded-full flex-shrink-0 ${is2FAEnabled ? "bg-green-500" : "bg-red-500"}`}
              />
            )}
              ...
              >
                ...
                >
                  <clipPath id="header-theme-toggle-clip">
                    <motion.path
                      animate={{
                        y: themeMode === "dark" ? 10 : 0,
                        x: themeMode === "dark" ? -12 : 0,
                      }}
            ...
            <DropdownMenuTrigger asChild>
              {user?.type === "user" ? (
                <div className="flex cursor-pointer">
                  ...
                  <div className="flex sm:hidden h-8 w-8 items-center justify-center rounded-full border border-primary/80 bg-background/80 shadow-sm backdrop-blur-sm transition-all duration-200 hover:shadow-md hover:border-primary p-1">
                    <div className="relative flex-shrink-0 rounded-full border border-primary/80 p-1">
                  ...
                  <div className="hidden sm:flex items-center gap-2.5 rounded-full border border-primary/80 bg-background/80 px-3 py-1.5 shadow-sm backdrop-blur-sm transition-all duration-200 hover:shadow-md hover:bg-background hover:border-primary p-1">
                    <div className="relative flex-shrink-0">
                      <div className="flex h-7 w-7 items-center justify-center rounded-full border border-primary/80 bg-background/80 shadow-sm backdrop-blur-sm">
