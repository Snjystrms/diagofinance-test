            ...
            <DropdownMenuTrigger asChild>
              {user?.type === "user" ? (
                <div className="flex cursor-pointer">
                  ...
                  <div className="flex sm:hidden h-8 w-8 items-center justify-center rounded-full border border-primary/60 bg-background/80 shadow-sm backdrop-blur-sm transition-all duration-200 hover:shadow-md hover:border-primary/70 p-1">
                    <div className="relative flex-shrink-0 rounded-full border border-primary/60 p-1">
                  ...
                  <div className="hidden sm:flex items-center gap-2.5 rounded-full border border-primary/60 bg-background/80 px-3 py-1.5 shadow-sm backdrop-blur-sm transition-all duration-200 hover:shadow-md hover:bg-background hover:border-primary/70 p-1">
                    <div className="relative flex-shrink-0">
                      <div className="flex h-7 w-7 items-center justify-center rounded-full border border-primary/60 bg-background/80 shadow-sm backdrop-blur-sm">
                ...
                <button className="flex h-8 w-8 sm:h-9 sm:w-9 flex-shrink-0 items-center justify-center rounded-full border border-primary/60 bg-background/80 shadow-sm backdrop-blur-sm transition-all duration-200 hover:shadow-md hover:bg-background hover:border-primary/70 p-1">
